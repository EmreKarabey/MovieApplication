...
{
    public class UnlikedMovieConfiguration : IEntityTypeConfiguration<UnlikedMovie>
    {
        public void Configure(EntityTypeBuilder<UnlikedMovie> builder)
        {
            builder.ToTable("UnlikedMovies").HasKey(n => n.EntityID);
