...
{
    public class LikedMovieConfiguration : IEntityTypeConfiguration<LikedMovie>
    {
        public void Configure(EntityTypeBuilder<LikedMovie> builder)
        {
            builder.ToTable("LikedMovies").HasKey(n => n.EntityID);
